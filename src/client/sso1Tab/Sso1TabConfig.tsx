...
/**
 * Implementation of sso1 Tab configuration page
 */
export const Sso1TabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            contentUrl: host + "/sso1Tab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/sso1Tab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "sso1 Tab",
            removeUrl: host + "/sso1Tab/remove.html?theme={theme}",
